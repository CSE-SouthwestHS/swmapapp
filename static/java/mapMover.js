...
module.exports = {
  enable: function(instance) {
    ...
    zoomGroup.setAttribute('transform', 'translate(' + ( instance.width - 265 ) + ' ' + ( instance.height - 320 ) + ') scale(3.2)');
...
, _createZoomIn: function(instance) {
    ...
    zoomIn.setAttribute('transform', 'translate(29.5 6) scale(0.018)');
...
, _createZoomReset: function(instance){
    ...
    resetPanZoomControl.setAttribute('transform', 'translate(15 38) scale(0.3)');
...
, _createZoomOut: function(instance){
    ...
    zoomOut.setAttribute('transform', 'translate(29.5 65) scale(0.018)');
